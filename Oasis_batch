...
input_directory_name = '/Project/COBRE_WORK/OASIS_gift/';
...
subject_dir_regexp = 'OAS\w+;fun\w+;';
...
outputDir = ['/home/users/mmisiura1/OASIS_memory7'];
...
maskFile = ['/home/users/mmisiura1/Oasis_mask/ica_analysisMask.nii'];
